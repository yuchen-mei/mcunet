...
PREVIOUS_LAYER = "InvRes11_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=320, out_channels=320, kernel_size=3, stride=1, padding=0, groups=320, bias=False)
