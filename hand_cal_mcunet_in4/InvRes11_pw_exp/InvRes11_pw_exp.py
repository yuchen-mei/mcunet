...
INVRES_BLOCK_NAME = 'blocks_10_mobile_inverted_conv_inverted_bottleneck'
PREVIOUS_LAYER = 'InvRes10_pw_sq_bias_skip'
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    pw_conv = torch.nn.Conv2d(in_channels=80, out_channels=320, kernel_size=1, stride=1, padding=0, bias=False)
