...
INVRES_BLOCK_NAME = 'blocks_10_mobile_inverted_conv_point_linear'
PREVIOUS_LAYER = 'InvRes11_dw_bias_relu6'
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    pw_conv = torch.nn.Conv2d(in_channels=320, out_channels=96, kernel_size=1, stride=1, padding=0, bias=False)
