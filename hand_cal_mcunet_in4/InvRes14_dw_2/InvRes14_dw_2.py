...
def preprocess(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    weight_npy = numpy.zeros((weights_npy_glb2.shape[0]+weights_npy_glb3.shape[0], weights_npy_glb2.shape[1], weights_npy_glb2.shape[2], weights_npy_glb2.shape[3]))
    weight_npy[0::2, :, :, :] = weights_npy_glb2[:, :, :, :]
    weight_npy[1::2, :, :, :] = weights_npy_glb3[:, :, :, :]
