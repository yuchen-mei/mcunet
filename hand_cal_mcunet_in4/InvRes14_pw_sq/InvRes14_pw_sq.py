...
INVRES_BLOCK_NAME = 'blocks_13_mobile_inverted_conv_point_linear'
PREVIOUS_LAYER = 'InvRes14_dw_bias_relu6'
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    pw_conv = torch.nn.Conv2d(in_channels=384, out_channels=192, kernel_size=1, stride=1, padding=0, bias=False)
