...
PREVIOUS_LAYER = "InvRes15_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=288, out_channels=288, kernel_size=7, stride=1, padding=0, groups=288, bias=False)
