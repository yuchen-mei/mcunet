...
GOLD_PAD_LEFT = 3
GOLD_PAD_RIGHT = 7
INVRES_BLOCK_NAME = 'blocks_14_mobile_inverted_conv_inverted_bottleneck'
PREVIOUS_LAYER = 'InvRes15_pw_exp'
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    if out_of_tolerance[0].size > 0:
        print("[FAIL] There are significant differences between the outputs.\n")
