...
PREVIOUS_LAYER = "InvRes16_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=576, out_channels=576, kernel_size=5, stride=1, padding=0, groups=576, bias=False)
