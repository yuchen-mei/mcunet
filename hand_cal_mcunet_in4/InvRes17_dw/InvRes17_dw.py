...
PREVIOUS_LAYER = "InvRes17_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=768, out_channels=768, kernel_size=5, stride=1, padding=0, groups=768, bias=False)
