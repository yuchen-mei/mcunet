...
def preprocess(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    input_npy = numpy.load('../sequential_0_bias_relu6/halide_data/hw_output.npy')
    weight_npy = numpy.load(WEIGHT_PTH + 'blocks_0_mobile_inverted_conv_depth_conv_conv_weight_weights.npy')
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=0, groups=32, bias=False)
