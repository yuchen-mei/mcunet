...
INVRES_BLOCK_NAME = 'blocks_3_mobile_inverted_conv_inverted_bottleneck'
PREVIOUS_LAYER = 'InvRes3_pw_sq_bias_skip'
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    pw_conv = torch.nn.Conv2d(in_channels=24, out_channels=96, kernel_size=1, stride=1, padding=0, bias=False)
