...
PREVIOUS_LAYER = "InvRes6_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=160, out_channels=160, kernel_size=3, stride=1, padding=0, groups=160, bias=False)
