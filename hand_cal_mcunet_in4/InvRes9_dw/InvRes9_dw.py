...
PREVIOUS_LAYER = "InvRes9_pw_exp_bias_relu6"
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    dw_conv = torch.nn.Conv2d(in_channels=240, out_channels=240, kernel_size=3, stride=1, padding=0, groups=240, bias=False)
