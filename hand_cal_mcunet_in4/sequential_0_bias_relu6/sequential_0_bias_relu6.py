...
def preprocess(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    input_npy = numpy.load('../sequential_0/halide_data/hw_output.npy')
...
def layer(WORK_DIR, ACT_PTH, WEIGHT_PTH, HALIDE_PTH):
    ...
    gold_output_npy = numpy.load(ACT_PTH + 'first_conv/first_conv_out.npy')
    ...
    if out_of_tolerance[0].size > 0:
        ...
        print("\nThe outputs are effectively identical within the tolerance.\n")
